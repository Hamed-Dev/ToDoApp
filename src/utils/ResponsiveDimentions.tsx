...
const decorateHeights: number = Platform.OS === 'android' ? StatusBar.currentHeight || 0 : 0;
...
export const heightPercent = (h: number) =>
...
export const responsiveFontSize = (f: number, factor = 0.5) => {
